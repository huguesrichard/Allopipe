...
To run the AAMS pipeline of AlloPipe on the previous example, go to its root directory and run the following commands in the terminal :  
 	...
 	mkdir ../tutorial/Ensembl
   	wget https://ftp.ensembl.org/pub/release-103/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.cdna.all.fa.gz https://ftp.ensembl.org/pub/release-103/fasta/homo_sapiens/pep/Homo_sapiens.GRCh38.pep.all.fa.gz https://ftp.ensembl.org/pub/release-103/tsv/homo_sapiens/Homo_sapiens.GRCh38.103.refseq.tsv.gz -P ../tutorial/Ensembl/
	gzip -d ../tutorial/Ensembl/Homo_sapiens.GRCh38.cdna.all.fa.gz && gzip -d ../tutorial/Ensembl/Homo_sapiens.GRCh38.pep.all.fa.gz && gzip -d ../tutorial/Ensembl/Homo_sapiens.GRCh38.103.refseq.tsv.gz
